...
export default function CustomerDeliveries() {
  ...
  const navItems = [
    ...
    { label: "My Deliveries", icon: Package, active: true },
    ...
    <div className="min-h-screen w-full bg-slate-50 flex">
      ...
      <main className="flex-1 min-w-0 pt-16 md:pt-0">
        <div className="px-5 sm:px-8 py-6 sm:py-8 max-w-5xl mx-auto">
          {/* Header */}
          <div className="mb-6">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900">My Deliveries</h1>
            <p className="text-sm text-slate-500 mt-0.5">Everything headed your way.</p>
          </div>
