...
const navItems = [
  ...
  { label: "Drivers", icon: Truck, active: true },
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center rounded-xl border border-slate-200 bg-white px-6 py-24 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-slate-100">
        <UserRound className="text-slate-400" size={26} />
      </div>
      <h3 className="mt-5 text-base font-semibold text-slate-900">
        No drivers yet
      </h3>
      <p className="mt-1 max-w-sm text-sm text-slate-500">
        Available drivers appear here.
      </p>
    </div>
  );
}

export default function DropSyncDrivers() {
